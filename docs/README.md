...
| [`design/0.2.0-execution-plan.md`](design/0.2.0-execution-plan.md) | The 328 requirements decomposed into 40 issues with dependencies, sizes, and a coverage check |
