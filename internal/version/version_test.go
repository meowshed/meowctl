...
func TestString_CustomValues(t *testing.T) {
	...
	// for ldflags injection. Direct mutation is safe here because no t.Parallel()
	// is used in this file. If parallelism is added, replace with a
	// version.New(v, commit, date) constructor instead.
